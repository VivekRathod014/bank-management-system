...
%>
<div class="navbar">
    <span class="bank-name">JQS Bank</span>
    <a href="customerHomePage.jsp" class="button">Customer Home Page</a>
</div>
<div class="container">
    <h1>Transfer Funds</h1>
    <p>Your Account Balance: ₹<span id="accountBalance"><%=customer.getAccount_balance()%></span></p>

    <form action="TransferFunds" method="post">
        <div class="form-group">
            <label for="userId">Your User ID:</label>
            <input type="text" name="c_userId" value="<%=customer.getC_id()%>" required>
        </div>
        <div class="form-group">
            <label for="transferId">Recipient's User ID:</label>
            <input type="text" name="c_transferId" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" name="c_amount" required>
        </div>
