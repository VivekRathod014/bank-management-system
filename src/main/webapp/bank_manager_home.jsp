...
<form action="Home" method="post">
    <div id="navbar"> 
        ...
        <div id="bank-name">BOB Bank </div> <!-- Add the bank name here -->
        <div id="manager-name">Manager Name</div> <!-- Add the manager name here -->
    </div>
    <div id="buttons">
        <a href="allCustomers.jsp" class="button">All Customers</a>
        <a href="viewApprovedCustomers.jsp" class="button">Approved Customers</a>
