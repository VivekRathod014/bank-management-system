...
<body>
	...
	<div class="container">
		...
		<form action="withdrawalMoney" method="post">
			<label for="id">Customer ID:</label> <input type="text" name="c_id"
				value="<%=customer.getC_id()%>" required><br> <br>
			<label for="username">Username:</label> <input type="text"
				name="c_username" required><br> <br> <label
				for="password">Password:</label> <input type="password"
				name="c_password" required><br> <br> <label
				for="withdrawAmount">Withdraw Amount:</label> <input type="number"
				name="c_withdrawAmount" required><br> <br> <input
